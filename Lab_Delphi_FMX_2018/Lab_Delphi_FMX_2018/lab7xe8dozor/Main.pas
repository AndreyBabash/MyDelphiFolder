...
{$IFDEF ANDROID}
    ...
    Toast('Координаты: '+Marker.Descriptor.Position.Latitude.ToString+' '+Marker.Descriptor.Position.Longitude.ToString, Android.JNI.Toast.LongToast)
  else
    Toast('Мой маркер!)))', Android.JNI.Toast.LongToast);
{$ENDIF}
end;
