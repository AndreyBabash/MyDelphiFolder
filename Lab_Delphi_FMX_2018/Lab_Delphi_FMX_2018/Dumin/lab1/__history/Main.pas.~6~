...
type
  TMainForm = class(TForm)
    ...
    Button4: TButton;
    Button5: TButton;
    Starchenko_Memo: TMemo;
    CheckBox1: TCheckBox;
    ListBoxItem11: TListBoxItem;
    Starchenko_Button6: TButton;
    procedure Button3Click(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure Button5Click(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure Button1Click(Sender: TObject);
    procedure Starchenko_Button6Click(Sender: TObject);
    ...
    procedure(const AResult: TModalResult; const AValues: array of string)
      begin
        case AResult of
          ...
          begin
           ...
           fontsize:=AValues[0];
            ...
            if fontsize<>'' then
             ...
             Starchenko_Memo.Font.Size:=StrToInt(fontsize)

              else

              Starchenko_Memo.Font.Size:=20;
          ...
          Starchenko_Memo.FontColor:=textcolor;

          //Выводим строку в текстовое поле

              Starchenko_Memo.Lines.Add(str);
...
procedure TMainForm.Starchenko_Button6Click(Sender: TObject);
var MyIni:TIniFile;
begin
