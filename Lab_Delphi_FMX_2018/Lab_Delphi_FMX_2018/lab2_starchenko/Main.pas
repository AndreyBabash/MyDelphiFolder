...
// Выбор типа линии
  ...
  PaintBox1.Canvas.DrawRect(TRectF.Create(PaintBox1.Width/2, 10, PaintBox1.Width-10, PaintBox1.Height/2), 20, 20, [TCorner.TopRight,TCorner.BottomRight], 1); //виведення прямокутника

// Первая линия

  p1.X:=Round(PaintBox1.Width/2);
  p1.Y:=10;

  p2.X:=Round(PaintBox1.Width/2);
