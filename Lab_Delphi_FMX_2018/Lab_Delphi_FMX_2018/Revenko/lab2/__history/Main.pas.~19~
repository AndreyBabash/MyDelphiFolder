...
// Первая линия
  ...
  PaintBox1.Canvas.FillText(TRectF.Create(0, 0, 200, 200),'Hello!!!',true,0.5,[],TTextAlign.Center,TTextAlign.Center);

  PaintBox1.Canvas.Font.Size:=30;
  PaintBox1.Canvas.Font.Style:=[TFontStyle.fsItalic,TFontStyle.fsUnderline];
  PaintBox1.Canvas.Fill.Color:=TAlphaColors.Red;
  PaintBox1.Canvas.FillText(TRectF.Create(0, 0, 500, 500),FloatToStr(PI),true,0.5,[],TTextAlign.Center,TTextAlign.Center);
  //PaintBox1.Canvas.FillText(TRectF.Create(10, 10, 200, 200),'Hello!!!',false,1.0,[],TTextAlign.Center,TTextAlign.Center);
  PaintBox1.Canvas.DrawRect(TRectF.Create(10, 10, PaintBox1.Width-10, PaintBox1.Height-10), 20, 20, [TCorner.TopRight,TCorner.BottomRight], 1); //виведення прямокутника
...
// Вторая линия
  ...
  PaintBox1.Canvas.DrawLine(p1,p2,1.0);
  PaintBox1.Canvas.DrawPath(path,1.0);

  PaintBox1.Canvas.EndScene;

end;

// Подтверждение выхода из приложения при переключении Switch
