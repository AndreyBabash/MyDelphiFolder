...
type
  TMainForm = class(TForm)
    ...
    Label2: TLabel;
    Button4: TButton;
    Revenko_Button5: TButton;
    Revenko_Memo: TMemo;
    CheckBox1: TCheckBox;
    ListBoxItem11: TListBoxItem;
    Revenko_Button6: TButton;
    procedure Button3Click(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure Revenko_Button5Click(Sender: TObject);
    procedure FormCreate(Sender: TObject);
    procedure Button1Click(Sender: TObject);
    procedure Revenko_Button6Click(Sender: TObject);
...
procedure TMainForm.Revenko_Button5Click(Sender: TObject);
    ...
    procedure(const AResult: TModalResult; const AValues: array of string)
      begin
        case AResult of
          ...
          begin
           ...
           fontsize:=AValues[0];
            ...
            if fontsize<>'' then
             ...
             Revenko_Memo.Font.Size:=StrToInt(fontsize)

              else

              Revenko_Memo.Font.Size:=20;
          ...
          Revenko_Memo.FontColor:=textcolor;

          //Выводим строку в текстовое поле

              Revenko_Memo.Lines.Add(str);
...
procedure TMainForm.Revenko_Button6Click(Sender: TObject);
var MyIni:TIniFile;
begin
